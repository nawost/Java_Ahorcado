...
public class VentanaAhorcado extends javax.swing.JFrame {
    ...
    String palabraOculta = ""; //Palabra a adivinar
    // Lista de las palabras que pueden salir en el juego.
    String [] listaPalabras = {"Barcelona", "Milan", "Londres", "Tokio", "Bergen", "Chicago"};
    boolean juegoTerminado = false;
    int numeroFallos = 0;
    
    
    // Elige aleatoriamente una palabra de listaPalabras
    private String eligePalabraOculta (String [] lista){
        Random aleatorio = new Random();
        return lista[aleatorio.nextInt(lista.length)];
    }
    //Hace que meta los mismo guiones bajos que letras de la palabra que ha salido
    ...
    public void chequeaLetra(String letra){
        ...
        if (palabraOculta.contains(letra)){
            ...
            numeroFallos = -1;
            dibujaImagen(-1);
            JOptionPane.showMessageDialog(this, "ENHORABUENA, GANASTE");//mensaje de victoria donde se cerrara el programa
            System.exit(0);
            juegoTerminado = true;
        }
        }else{
            ...
            if (numeroFallos == 6){
                JOptionPane.showMessageDialog(this, "Perdiste");//mensaje de derrota y se cerrara el programa
                System.exit(0);
                juegoTerminado = true;
            }
    ...
    public void chequeaBoton(JButton miBoton){
        //meto una condición donde si el juego se ha terminado los botones dejaran de funcionar
       if(!juegoTerminado){
    ...
    public VentanaAhorcado() {
        ...
        System.out.print(palabraOculta);//Muestra la palabra seleccionada aleatoriamente
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jButtonA, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jButtonB, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(44, 44, 44)
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(panelGuiones, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
